...
import 'package:yns_collage_management/pages/Teacher/bottom_navbar.dart';
import 'package:yns_collage_management/Utils/routes.dart';

class TeachersSignUpPage extends StatefulWidget {
  const TeachersSignUpPage({super.key});

  @override
  State<TeachersSignUpPage> createState() => _TeachersSignUpPageState();
}

class _TeachersSignUpPageState extends State<TeachersSignUpPage> {
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelText: "Enter Your Teachers ID.",
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    String cpasswordstr = cPassword.text.toString();
                    ...
                    if (idstr == adminId) {
                        ...
                        if (passwordstr == cpasswordstr) {
                          Navigator.pushReplacement(
                            ...
                            PageTransition(
                              ...
                              child: const TeachersBottomnavBar(),
                            ),
                          );
                        } else {
                          showDialog(
                      ...
                      showDialog(
                          ...
                          builder: (ctx) => AlertDialog(
                                ...
                                content: const Text(
                                  "Please Enter Valid Teachers ID... ",
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 13),
