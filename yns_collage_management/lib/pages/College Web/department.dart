      ...
      body: SingleChildScrollView(
        ...
        children: [
          ...
          Padding(
            ...
            //Heading
            child: Text(
              "Department of Computer Science (B.C.A.)",
              style: TextStyle(
                  fontSize: 25,
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.all(16.0),
              child: Text(
                "BBA (Bachelor of Business Administration) Course",
                style: TextStyle(
                  fontSize: 20,
                  fontWeight: FontWeight.w900,
                  color: Colors.teal[900],
            ...
            Padding(
              padding: const EdgeInsets.all(16.0),
              child: Text(
                "B.Com (Bachelor of Commerce) Course",
                style: TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.w900,
                    color: Colors.teal[900]),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 8, right: 8, top: 8),
              child: Text(
                "M.Com (Masters of Commerce) Course",
                style: TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.w900,
                    color: Colors.teal[900]),
            ...
            const Padding(
              padding: EdgeInsets.all(8.0),
              child: Text(
                "BBA/B.Com with 33 % marks in aggregate.",
                textAlign: TextAlign.center,
                style:
                    TextStyle(fontStyle: FontStyle.italic, color: Colors.white),
              ),
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(left: 8, right: 8, top: 8),
              child: Text(
                "B. Sc Biology Jobs and career prospects",
                style: TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.w900,
                    color: Colors.teal[900]),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 8, right: 8, top: 8),
              child: Text(
                "B.Sc Mathematics Jobs and Career Prospects",
                style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.w900,
                    color: Colors.teal[900]),
