      ...
      body: SingleChildScrollView(
        child: Column(children: [
            ...
            child: InkWell(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    PageTransition(
                        type: PageTransitionType.fade, child: const Dep_Bio()));
              },
              child: Ink(
                decoration: BoxDecoration(
                  color: Colors.white,
            ...
            child: InkWell(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    PageTransition(
                        type: PageTransitionType.fade, child: const Dep_BSC()));
              },
              child: Ink(
                decoration: BoxDecoration(
                  color: Colors.white,
          ...
          InkWell(
            ...
            child: const Text(
              "UGC e-resources portel :-",
              style: TextStyle(
                  shadows: [
                    Shadow(
                        color: Colors.red, blurRadius: 5, offset: Offset(2, 2))
                  ],
                  fontSize: 25,
