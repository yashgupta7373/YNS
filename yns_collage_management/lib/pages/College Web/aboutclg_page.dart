        ...
        child: Column(children: [
              ...
              style: OutlinedButton.styleFrom(
                ...
                shape: const RoundedRectangleBorder(
                  borderRadius: BorderRadius.vertical(
                      top: Radius.circular(25), bottom: Radius.circular(11)),
                ),
              ),
              child: const Text(
                "Management Committee",
          ...
          SizedBox(
            ...
            child: OutlinedButton(
              ...
              child:
                  const Text("Founder", style: TextStyle(color: Colors.white)),
              onPressed: () {
                Navigator.push(
                    context,
                    PageTransition(
